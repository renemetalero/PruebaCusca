...
## Compatibility endpoints (RenePruebaCusca style)

To support the alternative Postman collection format, this project also exposes:

- `POST /api-prueba-cuscatlan/authentication/getToken`
- `POST /api-prueba-cuscatlan/authentication/renewToken`
- `POST /api-prueba-cuscatlan/orderRegistration`
- `PUT /api-prueba-cuscatlan/orderRegistration`
- `DELETE /api-prueba-cuscatlan/orderRegistration/delete/{id}`
- `GET /api-prueba-cuscatlan/orderRegistration/getAllOrders`
- `GET /api-prueba-cuscatlan/orderRegistration/getAnOrder/{id}`
- `GET /api-prueba-cuscatlan/products/getAllProducts`
- `GET /api-prueba-cuscatlan/products/getAProduct/{id}`
- `POST /api-prueba-cuscatlan/paymentOrder`
- `PUT /api-prueba-cuscatlan/paymentOrder`
